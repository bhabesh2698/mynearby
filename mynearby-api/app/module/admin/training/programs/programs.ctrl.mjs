...
class programController {
   ...
   /*  async extractFirst20Words(str) {
    ...
    /**
        * URL : api/admin/programs/addProgram
        * DETAILS : user signup
...
**/
    ...
    async deleteProgram(req, res) {
        ...
        try {
            ...
            let path = 'public/program-image/' + reqData.id;
            ...
            let deleteProgramFolder = await uploadHelper.deleteFolderRecursive(path);
       ...
       /**
 * URL : api/admin/program/programImage
 ...
 **/
       async programImage(req, res) {
        ...
        try {
            ...
            console.log("imagar:::", updateProgramPic[1]);
